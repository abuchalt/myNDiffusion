...
% Physical params
% Output of Proj2 Already Normalized to 3000--- not necessary
...
myCWD = pwd;
subfolder = 'results\\project2\\'+string(maxNodes)+'x'+string(maxNodes);
plotsfolder = [num2str(fuelDim),'_',num2str(modDim),'_',num2str(size)];
fprintf(['Pulling Heat Gen From ',plotsfolder,':\n'])
...
for mygroup = 1:G
    ...
    q3prime = q3prime + phiunPlot(:)/1000;
end
